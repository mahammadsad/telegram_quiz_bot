(function(){
  ...
  function load(){show("loading");fetcher(api("/api/syllabus"),{cache:"no-store"}).then(check).then(function(data){payload=data;buildFilters();render()}).catch(function(){show("error")})}
