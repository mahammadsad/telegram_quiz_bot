...
from database.contract import (
    ...
    DIFFICULTY_AWARE_REPLENISHMENT_MIGRATION_VERSION,
...
def test_platform_contract_remains_the_scheduler_gate_after_additive_migrations() -> None:
    ...
    assert LATEST_MIGRATION_VERSION == DIFFICULTY_AWARE_REPLENISHMENT_MIGRATION_VERSION
    assert CURRENT_AFFAIRS_CHAPTER_GROUNDING_MIGRATION_VERSION < LATEST_MIGRATION_VERSION
    ...
    assert PLATFORM_CONTRACT_MIGRATION_VERSION == CURRENT_AFFAIRS_CHAPTER_GROUNDING_MIGRATION_VERSION
