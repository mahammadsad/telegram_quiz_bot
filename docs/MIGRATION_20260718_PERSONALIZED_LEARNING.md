...
1. `20260718184133_personalized_learning_foundation.sql`
2. `20260718184138_personalized_learning_fk_compatibility.sql`
3. `20260718185411_remove_redundant_personal_review_unique.sql`
